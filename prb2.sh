...
IPADAPTER_MODELS=(
	...
	"https://huggingface.co/h94/IP-Adapter/resolve/main/models/ip-adapter-plus_sdxl_vit-h.safetensors"
	"https://huggingface.co/h94/IP-Adapter/resolve/main/models/ip-adapter-plus-face_sdxl_vit-h.safetensors"
	"https://huggingface.co/h94/IP-Adapter/resolve/main/models/ip-adapter_sdxl.safetensors"
)
...
function provisioning_start() {
	...
	mv ./workspace/ComfyUI/models/esrgan/model.safetensors ./workspace/ComfyUI/models/clip_vision/CLIP-ViT-bigG-14-laion2B-39B-b160k.safetensors
