...
DEFAULT_WORKFLOW="https://pasteb in.com/tzPWd8s2"
...
function provisioning_start() {
	...
	DIR_PATH1="${WORKSPACE}/storage/stable_diffusion/models/grounding-dino"
	DIR_PATH2="${WORKSPACE}/storage/stable_diffusion/models/ipadapter"
	mkdir -p DIR_PATH1
	mkdir -p DIR_PATH2
